...
try:
    ...
    if not lightsarg or not iparg or not brightnessarg and not brightnesslightarg and not randombrightnessargs:
        print('Please create one or',
        'to use without a config file -i, -l and either -rb -b -bl'
        'use -h to see aditionl falsg and how to use them')
        sys.exit(0)
